...
public class SwingControlDemo10 {
    private JFrame mainFrame;
    private JLabel headerLabel;
    private JLabel statusLabel;
    private JPanel controlPanel;

    public SwingControlDemo10(){
        prepareGUI();
    }
    public static void main(String[] args){
        SwingControlDemo10  SwingControlDemo10 = new SwingControlDemo10();
        SwingControlDemo10.showTextAreaDemo();
    }
