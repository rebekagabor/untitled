...
public class SwingControlDemo17 {
    private JFrame mainFrame;
    private JLabel headerLabel;
    private JLabel statusLabel;
    private JPanel controlPanel;

    public SwingControlDemo17(){
        prepareGUI();
    }
    public static void main(String[] args){
        SwingControlDemo17  SwingControlDemo17 = new SwingControlDemo17();
        SwingControlDemo17.showSpinnerDemo();
    }
