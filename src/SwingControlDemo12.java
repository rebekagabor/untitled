...
public class SwingControlDemo12 {
    private JFrame mainFrame;
    private JLabel headerLabel;
    private JLabel statusLabel;
    private JPanel controlPanel;

    public SwingControlDemo12(){
        prepareGUI();
    }
    public static void main(String[] args){
        SwingControlDemo12  SwingControlDemo12 = new SwingControlDemo12();
        SwingControlDemo12.showScrollbarDemo();
    }
