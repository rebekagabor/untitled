...
public class SwingControlDemo11 {
    ...
    public static void main(String[] args){
        SwingControlDemo11  SwingControlDemo11 = new SwingControlDemo11();
        SwingControlDemo11.showImageIconDemo();
    }
    ...
    private static ImageIcon createImageIcon(String path,
                                             String description) {
        java.net.URL imgURL = SwingControlDemo11.class.getResource(path);
